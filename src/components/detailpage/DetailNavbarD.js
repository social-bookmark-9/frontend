...
import ChangeTagD from "./ChangeTagD";

import Swal from "sweetalert2";

const DetailNavbarD = props => {
        ...
        {folderModalOpen ? (
          <Section>
            ...
            <MainModal>
              ...
              {showFolderModal ? (
                <ChangeTagD tagList={tagList} articleId={articleId} />
              ) : (
                <Main>
                  <LinkBox>
                    <EditBox>
